...
function EvaluatorTab() {
  ...
  const evaluate=async()=>{
    ...
    try {
      const raw=await callClaude([{role:"user",content:`IMPORTANTE: Responde TODO en ESPANOL. Cada campo del JSON debe estar en ESPANOL sin excepcion.\n\nPrompt a evaluar:\n\n${prompt}\n\nRecuerda: responde UNICAMENTE con el JSON en una sola linea y TODO en ESPANOL.`}],EVAL_SYSTEM);
