 ...
 */var G=m,_=Symbol.for("react.element"),V=Symbol.for("react.fragment"),J=Object.prototype.hasOwnProperty,Y=G.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Q={key:!0,ref:!0,__self:!0,__source:!0};function B(a,i,n){var s,r={},t=null,c=null;n!==void 0&&(t=""+n),i.key!==void 0&&(t=""+i.key),i.ref!==void 0&&(c=i.ref);for(s in i)J.call(i,s)&&!Q.hasOwnProperty(s)&&(r[s]=i[s]);if(a&&a.defaultProps)for(s in i=a.defaultProps,i)r[s]===void 0&&(r[s]=i[s]);return{$$typeof:_,type:a,key:t,ref:c,props:r,_owner:Y.current}}h.Fragment=V;h.jsx=B;h.jsxs=B;w.exports=h;var e=w.exports,v={},D=q;v.createRoot=D.createRoot,v.hydrateRoot=D.hydrateRoot;const o={bg:"#eef3fb",surface:"#f7f9fd",card:"#ffffff",border:"#d0daf0",borderHi:"#8aaee0",navy:"#1a3968",navyLight:"#e8eef8",blue:"#2563b8",blueLight:"#dbeafe",sky:"#0284c7",skyLight:"#e0f2fe",green:"#047857",greenLight:"#d1fae5",red:"#b91c1c",redLight:"#fee2e2",amber:"#b45309",amberLight:"#fef3c7",purple:"#6d28d9",purpleLight:"#ede9fe",teal:"#0f766e",tealLight:"#ccfbf1",text:"#1e2d45",muted:"#5a7194",shadow:"0 2px 16px rgba(30,57,104,0.09)",shadowLg:"0 8px 32px rgba(30,57,104,0.13)"},F={Productividad:{color:o.amber,light:o.amberLight,icon:"⚡"},Escritura:{color:o.blue,light:o.blueLight,icon:"✍️"},Imágenes:{color:o.purple,light:o.purpleLight,icon:"🎨"},Minutas:{color:o.green,light:o.greenLight,icon:"📝"},Auditoría:{color:o.red,light:o.redLight,icon:"🔍"},Legal:{color:o.teal,light:o.tealLight,icon:"⚖️"},Finanzas:{color:o.sky,light:o.skyLight,icon:"📊"}},K=[{id:1,cat:"Productividad",icon:"⚡",title:"Priorización de tareas diarias",desc:"Organiza tu día con claridad usando el método Eisenhower.",prompt:`Actúa como un coach de productividad experto en el método GTD y la técnica Eisenhower.
